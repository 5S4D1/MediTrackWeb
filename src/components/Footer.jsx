...
function Footer() {
  ...
  return (
    <footer className="bg-[#060010] border-t border-white/10 mt-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Smart Health Companion for Families. Manage medications, store prescriptions, 
              and get AI-powered health insights. All in one secure, user-friendly app.
            </p>
            <div className="flex space-x-4">
              <a
                href="#"
                className="w-10 h-10 bg-white/5 hover:bg-blue-500/20 rounded-lg flex items-center justify-center transition-colors border border-white/10"
                aria-label="Facebook"
              >
              ...
              <a
                href="#"
                className="w-10 h-10 bg-white/5 hover:bg-green-500/20 rounded-lg flex items-center justify-center transition-colors border border-white/10"
                aria-label="LinkedIn"
              >
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                href="https://github.com/5S4D1/MediTrackWeb"
                className="w-10 h-10 bg-white/5 hover:bg-blue-500/20 rounded-lg flex items-center justify-center transition-colors border border-white/10"
                aria-label="GitHub"
              >
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
